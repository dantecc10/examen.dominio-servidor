    ...
    <div>
        ...
        <form action="ResultadosLyC.php" method="POST">
            <table id="InsertarResultados" class="Examen">
                <label for='Pregunta1'>Texto narrativo escrito en prosa o en verso donde sus personajes a menudo son animales que personifican a seres humanos y nos dejan una enseñanza</label>
                ...
                <label for='Pregunta2'>Obra literaria escrita en prosa considerada el subgénero más importante del género narrativo</label>
                ...
                <label for='Pregunta3'>Es un relato en el que se cuenta una historia real o ficticia que ocurre en un lugar y tiempo concretos</label>
                ...
                <label for='Pregunta4'>Es decir con tus propias palabras lo que acabas de leer</label>
                ...
                <label for='Pregunta5'>Consiste en explicar un tema a una audiencia ya sea en forma oral o escrita con la intención de informar</label>
                ...
                <label for='Pregunta6'>Es pintar con palabras un objeto, persona, lugar o situación</label>
                ...
                <label for='Pregunta7'>Es un documento de carácter descriptivo y extensión breve en el que se presenta algo al público</label>
                ...
                <label for='Pregunta8'>Facultad humana de intercambiar ideas y sentimientos, a través de una lengua, por medio del habla</label>
                ...
                <label for='Pregunta9'>Texto escrito en el que se relatan vivencias. Generalmente son textos privados, en el que se escriben meditaciones, reflexiones o hechos ocurridos que son importantes para el autor</label>
                ...
                <label for='Pregunta10'>Conversación entre dos o más personas, realizada de manera formal, con la intención fundamental de recoger noticias, comentarios, opiniones o interpretaciones, sobre variados temas, de los cuales la o las personas entrevistadas poseen especial información</label>

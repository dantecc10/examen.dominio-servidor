...
<head>
    ...
    <title>Examen diagnóstico de historia socioeconómica de México</title>
</head>
...
<body>
    ...
    <div id="DivInicioSesión" class="modal">
        <form class="modal-content animate" action="" method="post">
            ...
            include "../Controlador/controlador_login_hse.php"; //CAMBIAR LOGIN
            ?>
    ...
    <h2>Examen diagnóstico - Historia Socioeconómica de México</h2>

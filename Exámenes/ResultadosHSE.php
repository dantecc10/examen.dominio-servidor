...
<head>
    ...
    <title>Resultados del examen de historia socioeconómica de México</title>
</head>
...
<body>
    ...
    <div>
        ...
        <table class="InsertarResultados Examen">
            <?php
            $consulta = "SELECT * FROM `preguntas_hse`";
        ...
        <?php
        $consulta = ("INSERT INTO `resultados_hse`(`ID`, `Alumno`, `Calificación`) VALUES ('" . $_SESSION['ID'] . "','" . $_SESSION['Nombre'] . " " . $_SESSION['Apellidos'] . "','" . $aciertos .  "')");
        //echo $consulta;

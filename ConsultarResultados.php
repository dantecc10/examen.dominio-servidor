...
<head>
    ...
    <title>Resultados de las evaluaciones diagnósticas - Administración</title>
</head>
...
<body>
    ...
    <div>
        ...
        <br>
        <p class="Descripción-Artículo">Resultados Historia socioeconómica de México:</p>
        <table class="InsertarResultados Examen">
            <?php
            $consulta = "SELECT * FROM `resultados_hse`";
            $resultado = mysqli_query($conexión, $consulta) or die("Error en la consulta a la base de datos");
            echo ('<tr>');
            echo ('<th>ID</th>');
            echo ('<th>Nombre</th>');
